...
exports.meta.types.EncounterDetails = {
    tag: 'recordOf', 
    items: {
      patient: damlTypesMeta.Party,
      encounterId: damlTypesMeta.Text,
      procedureCode: exports.meta.types.ProcedureCode,
      diagnosisCode: exports.meta.types.DiagnosisCode,
      allowedAmount: damlTypesMeta.Optional(damlTypesMeta.Numeric(10)),
      coPay: damlTypesMeta.Optional(damlTypesMeta.Numeric(10)),
      patientResponsibility: damlTypesMeta.Optional(damlTypesMeta.Numeric(10)),
...
exports.meta.types.DiagnosisCode = { tag: 'enum',
  items: [
    'Fracture_of_scaphoid_bone_right_wrist_S62_001',
...
exports.meta.types.ProcedureCode = { tag: 'enum',
  items: [
    'Preventative_Care',
    'Physicals',
    'Sick_Visits',
...
exports.meta.types.PolicyType = { tag: 'enum',
  items: [
    'Gold',
    'Bronze',
  ]}
...
exports.meta.types.PayerDemographics = {
    tag: 'recordOf', 
    items: {
      payerHIN: damlTypesMeta.Text,
      payerTaxID: damlTypesMeta.Text,
      payerBankDFINumber: damlTypesMeta.Text,
      payerBankAccountNumber: damlTypesMeta.Text,
      payerAddressFirstLine: damlTypesMeta.Text,
      payerAddressSecondLine: damlTypesMeta.Text,
      payerCity: damlTypesMeta.Text,
      payerState: damlTypesMeta.Text,
      payerZipCode: damlTypesMeta.Text,
    }
  }
;
...
exports.meta.types.ProviderDemographics = {
    tag: 'recordOf', 
    items: {
      providerHIN: damlTypesMeta.Text,
      providerTaxID: damlTypesMeta.Text,
      providerBankDFINumber: damlTypesMeta.Text,
      providerBankAccountNumber: damlTypesMeta.Text,
      providerType: exports.meta.types.ProviderType,
      providerAddressFirstLine: damlTypesMeta.Text,
      providerAddressSecondLine: damlTypesMeta.Text,
      providerCity: damlTypesMeta.Text,
      providerState: damlTypesMeta.Text,
      providerZipCode: damlTypesMeta.Text,
    }
  }
;
...
exports.meta.types.PatientDemographics = {
    tag: 'recordOf', 
    items: {
      patientGender: damlTypesMeta.Text,
      patientSocialSecurityNumber: damlTypesMeta.Text,
      patientDateOfBirth: damlTypesMeta.Text,
      patientAddressLine1: damlTypesMeta.Text,
      patientAddressLine2: damlTypesMeta.Text,
      patientCity: damlTypesMeta.Text,
      patientState: damlTypesMeta.Text,
      patientZipCode: damlTypesMeta.Text,
    }
  }
;
...
exports.meta.types.ProviderType = { tag: 'enum',
  items: [
    'Primary',
    'Specialist',
  ]}
