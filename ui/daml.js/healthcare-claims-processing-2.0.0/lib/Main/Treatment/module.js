...
exports.meta.types.CompleteTreatment = {
    tag: 'recordOf', 
    items: {
    }
  }
...
exports.meta.templates.Treatment = {
  template: exports.Treatment,
  choices: {
    Archive: {
    ...
    CompleteTreatment: {
      argument: exports.meta.types.CompleteTreatment,
      result: exports.meta.types.TreatmentOutput,
    },
  },
};
...
exports.meta.types.TreatmentOutput = {
    tag: 'recordOf', 
    items: {
      claimReq: damlTypesMeta.ContractId(Main_Claim.meta.types.ClaimRequest),
      patientReq: damlTypesMeta.ContractId(Main_Claim.meta.types.PatientPaymentRequest),
    }
  }
;
