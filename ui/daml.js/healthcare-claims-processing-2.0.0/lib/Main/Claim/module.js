...
exports.meta.types.AcceptPatientObligation = {
    tag: 'recordOf', 
    items: {
    }
  }
...
exports.meta.templates.PatientPaymentRequest = {
  template: exports.PatientPaymentRequest,
  choices: {
    Archive: {
    ...
    AcceptPatientObligation: {
      argument: exports.meta.types.AcceptPatientObligation,
      result: damlTypesMeta.ContractId(exports.meta.types.PatientObligation),
    },
  },
};
...
exports.meta.types.AcceptClaimRequest = {
    tag: 'recordOf', 
    items: {
    }
  }
...
exports.meta.templates.ClaimRequest = {
  template: exports.ClaimRequest,
  choices: {
    AcceptClaimRequest: {
      argument: exports.meta.types.AcceptClaimRequest,
      result: damlTypesMeta.ContractId(exports.meta.types.Claim),
    },
    Archive: {
      argument: pkgd14e08374fc7197d6a0de468c968ae8ba3aadbf9315476fd39071831f5923662.DA.Internal.Template.meta.types.Archive,
      result: damlTypesMeta.Unit,
...
exports.meta.templates.PaymentReceipt = {
  template: exports.PaymentReceipt,
  choices: {
    Archive: {
      argument: pkgd14e08374fc7197d6a0de468c968ae8ba3aadbf9315476fd39071831f5923662.DA.Internal.Template.meta.types.Archive,
      result: damlTypesMeta.Unit,
...
exports.meta.types.PayPatientObligation = {
    tag: 'recordOf', 
    items: {
    }
  }
...
exports.meta.templates.PatientObligation = {
  template: exports.PatientObligation,
  choices: {
    PayPatientObligation: {
      argument: exports.meta.types.PayPatientObligation,
      result: damlTypesMeta.ContractId(exports.meta.types.PaymentReceipt),
    },
    Archive: {
      argument: pkgd14e08374fc7197d6a0de468c968ae8ba3aadbf9315476fd39071831f5923662.DA.Internal.Template.meta.types.Archive,
      result: damlTypesMeta.Unit,
...
exports.meta.templates.Claim = {
  template: exports.Claim,
  choices: {
    PayClaim: {
      argument: exports.meta.types.PayClaim,
      result: pkg40f452260bef3f29dede136108fc08a88d5a5250310281067087da6f0baddff7.DA.Types.meta.types.Tuple2(damlTypesMeta.ContractId(exports.meta.types.PaymentReceipt), damlTypesMeta.ContractId(Main_Policy.meta.types.InsurancePolicy)),
    },
    Archive: {
      argument: pkgd14e08374fc7197d6a0de468c968ae8ba3aadbf9315476fd39071831f5923662.DA.Internal.Template.meta.types.Archive,
      result: damlTypesMeta.Unit,
