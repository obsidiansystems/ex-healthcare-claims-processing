...
exports.meta.types.DiscloseProcedure = {
    tag: 'recordOf', 
    items: {
...
exports.meta.types.UnlockAndIncrement = {
    tag: 'recordOf', 
    items: {
    }
  }
...
exports.meta.templates.Procedure = {
  template: exports.Procedure,
  choices: {
    Archive: {
    ...
    Lock: {
      argument: exports.meta.types.Lock,
      result: damlTypesMeta.ContractId(exports.meta.types.Procedure),
    },
    Unlock: {
      argument: exports.meta.types.Unlock,
      result: damlTypesMeta.ContractId(exports.meta.types.Procedure),
    },
    UnlockAndIncrement: {
      argument: exports.meta.types.UnlockAndIncrement,
      result: damlTypesMeta.ContractId(exports.meta.types.Procedure),
    },
    DiscloseProcedure: {
      argument: exports.meta.types.DiscloseProcedure,
      result: damlTypesMeta.ContractId(exports.meta.types.Procedure),
    },
  },
};
...
exports.meta.types.ProcedureFields = {
    tag: 'recordOf', 
    items: {
      copay: damlTypesMeta.Numeric(10),
      maxProcedures: damlTypesMeta.Int,
      scheduledProcedures: damlTypesMeta.Int,
      receivedProcedures: damlTypesMeta.Int,
    }
  }
;
