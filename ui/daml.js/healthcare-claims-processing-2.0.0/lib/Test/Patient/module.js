...
exports.meta.types.PatientScenarioOutput = {
    tag: 'recordOf', 
    items: {
      onboardResult: Test_Onboard.meta.types.OnboardResult,
      patient1Role: damlTypesMeta.ContractId(Main_Patient.meta.types.Patient),
      disclosedPolicyCid: damlTypesMeta.ContractId(Main_Policy.meta.types.DisclosedPolicy),
