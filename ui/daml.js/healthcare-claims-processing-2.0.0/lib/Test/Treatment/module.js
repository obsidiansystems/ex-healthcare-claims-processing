...
exports.meta.types.TreatmentScenarioOutput = {
    tag: 'recordOf', 
    items: {
      provider2Role: damlTypesMeta.ContractId(Main_Provider.meta.types.Provider),
      treatmentCid: damlTypesMeta.ContractId(Main_Treatment.meta.types.Treatment),
      paymentReq: Main_Treatment.meta.types.TreatmentOutput,
