...
exports.meta.types.CallStack = { tag: 'oneOf', 
  items: {
    EmptyCallStack: damlTypesMeta.Unit,
    PushCallStack: pkg40f452260bef3f29dede136108fc08a88d5a5250310281067087da6f0baddff7.DA.Types.meta.types.Tuple3(damlTypesMeta.Text, exports.meta.types.SrcLoc, exports.meta.types.CallStack),
    FreezeCallStack: exports.meta.types.CallStack,
  }
}
;
...
exports.meta.types.SrcLoc = {
    tag: 'recordOf', 
    items: {
      srcLocPackage: damlTypesMeta.Text,
      srcLocModule: damlTypesMeta.Text,
      srcLocFile: damlTypesMeta.Text,
      srcLocStartLine: damlTypesMeta.Int,
      srcLocStartCol: damlTypesMeta.Int,
      srcLocEndLine: damlTypesMeta.Int,
      srcLocEndCol: damlTypesMeta.Int,
    }
  }
;
